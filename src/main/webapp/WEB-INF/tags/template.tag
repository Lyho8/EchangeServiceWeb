			...
			<ul class="nav navbar-nav">
				...
				<sec:authorize access="isAuthenticated()">
					...
					<sec:authorize access="hasRole('ROLE_ADMIN')">
						...
						<li role="presentation" <c:if test="${requestScope['javax.servlet.forward.request_uri']=='/projetf/utilisateurs/lister'}">class="active"</c:if>><a href="<c:url value='/utilisateurs/lister/actifs' />">Gérer les utilisateurs</a></li>
