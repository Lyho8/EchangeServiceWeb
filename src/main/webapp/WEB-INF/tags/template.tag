		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav">
				...
				<sec:authorize access="isAnonymous()">
					<li role="presentation" <c:if test="${urlCourante=='inscriptionConnection'}">class="active"</c:if>><a href="#">Inscription</a></li>
				</sec:authorize>
			</ul>
			...
			<sec:authorize access="isAnonymous()">
				<form class="navbar-form navbar-left" role="login">
					<div class="form-group">
						<input type="text" class="form-control" placeholder="Login"> <input type="text" class="form-control" placeholder="Mot de passe">
					</div>
